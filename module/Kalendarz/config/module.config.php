 ...
 //W trybie 'pozwalajacym' jest odwrotnie, jeśli nie jest jawnie wpisany w klucz 'filtr_dostepu'
  //dostep do niego bedzie dla każdego 
        ...
        'controllers'=>[
            ...
            ['actions' => ['index','pokaz','pokazWydarzenie','edytuj','wpisz','autocomplete','searchlekarza4xml','wpiszjquery','wpiszjquery2','wpiszjquerykontrolawynikow','wpiszjquerykontrolawynikow2','usunjquery','edytujjquery2','edytujjquerykontrolawynikow2'], 'allow' => '*'],
